import { InvoiceData } from '../components/TaxInvoiceTemplate';
...
export function generateInvoiceHTML(data: InvoiceData): string {
  const itemsRows = data.items
    ...
    <tr>
      ...
      <td class="col-igst">${item.igstPercent.toFixed(2)}</td>
      <td class="col-cgst">${item.cgstPercent.toFixed(2)}</td>
      <td class="col-sgst">${item.sgstPercent.toFixed(2)}</td>
    </tr>
  `
    )
    .join('');
...
<head>
  ...
  <style>
    * {
    ...
    .col-sr { width: 4%; font-weight: bold; }
    .col-particulars { width: 28%; text-align: left !important; padding-left: 8px !important; font-weight: 500; }
    .col-hsn { width: 10%; font-family: 'Courier New', monospace; }
    .col-pcs { width: 6%; font-weight: bold; }
    .col-rate { width: 11%; text-align: right !important; padding-right: 6px !important; font-weight: 600; font-family: 'Courier New', monospace; }
    .col-disc { width: 7%; }
    .col-amount { width: 12%; text-align: right !important; padding-right: 6px !important; font-weight: bold; font-size: 9px; color: #000; font-family: 'Courier New', monospace; }
    .col-igst { width: 7%; }
    .col-cgst { width: 7%; }
    .col-sgst { width: 7%; }
    ...
    @media print {
      ...
      * {
      ...
      /* Force all content to be visible in print - highest specificity */
      .invoice-wrapper,
      .invoice-wrapper * {
        visibility: visible !important;
      }
      ...
      /* Override any hidden or display:none */
      [style*="display: none"],
      [style*="display:none"] {
  ...
  <div class="invoice-wrapper">
    <div class="top-section">
      ...
      <div class="seller-details-header">
        ...
        <div class="seller-info-line">GSTIN: ${data.gstin} | PAN: ${data.pan} | Udyam (MSME) No.: ${data.udyamNo}</div>
      </div>
      ...
      <div class="details-grid">
        ...
        <div class="detail-row">
          ...
          <span class="detail-value">${data.buyerGstin || ''}</span>
        </div>
        <div class="detail-row">
    ...
    <div class="bank-totals-section">
      ...
      <div class="totals-section">
        ...
        <div class="totals-grid">
          ...
          <div class="total-row">
            <span class="total-label">Sub Total (Taxable Value):</span>
            <span class="total-value">₹${data.subtotal.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
          </div>
          <div class="total-row">
            <span class="total-label">CGST @ 2.50%:</span>
            <span class="total-value">₹${data.cgstAmount.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
          </div>
          <div class="total-row">
            <span class="total-label">SGST @ 2.50%:</span>
            <span class="total-value">₹${data.sgstAmount.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
          </div>
